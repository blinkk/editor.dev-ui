...
import {AmagakiPartialData} from '../../../editor/api';
...
const MODAL_KEY_NEW = 'amagaki_partials_new';

export interface AmagakiPartialsFieldConfig extends FieldConfig {
  /**
...
export interface AmagakiPartialsFieldComponent {
  partials?: Record<string, AmagakiPartialData>;
}

// TODO: Refactor to share partials field between grow and amagaki.
export class AmagakiPartialsField
  extends ListField
  implements AmagakiPartialsFieldComponent {
  config: AmagakiPartialsFieldConfig;
  ...
  constructor(
    ...
    config: AmagakiPartialsFieldConfig,
    globalConfig: LiveEditorGlobalConfig,
    fieldType = 'amagaki_partials'
  ) {
    super(types, config, globalConfig, fieldType);
    this.config = config;
    this.globalConfig = globalConfig;
    this.ListItemCls = AmagakiPartialListFieldItem;
    ...
    if (!editor.parts.modals.modals[MODAL_KEY_NEW]) {
      ...
      modal.actions.push({
        ...
        onClick: () => {
          ...
          const partialConfig = this.partials[
            value.partial
...
class AmagakiPartialListFieldItem extends ListFieldItem {
  listField: AmagakiPartialsFieldComponent &
    ListFieldComponent &
    SortableFieldComponent;
